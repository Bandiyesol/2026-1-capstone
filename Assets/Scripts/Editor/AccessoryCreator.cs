...
public static class AccessoryCreator
{
    ...
    static List<AccessoryDef> GetAllAccessoryDefs()
    {
        ...
        list.Add(new AccessoryDef { fileName="ACC_C_004", displayName="무거운 동상",        grade=AccessoryGrade.Common, accessoryType="공격", description="투사체 크기 +10%",                     effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.ProjectileSize, 0.1f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_C_029", displayName="작은 약병",          grade=AccessoryGrade.Common, accessoryType="유틸", description="포션 효과 +5%",                       effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.HealingBonus, 0.05f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_C_033", displayName="신기한 화살",        grade=AccessoryGrade.Common, accessoryType="유틸", description="보스 방향 안내 화살표 활성화",        effectType=AccessoryEffectType.BossArrow, modifiers=new List<StatModifier>() });
        ...
        list.Add(new AccessoryDef { fileName="ACC_C_041", displayName="작살",             grade=AccessoryGrade.Common, accessoryType="공격", description="투사체 사거리 +10%",                  effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.ProjectileRange, 0.1f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_R_003", displayName="고대 불꽃의 핵",  grade=AccessoryGrade.Rare, accessoryType="속성", description="화염 속성 대미지 +15%, 화상 지속 +1초",  effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.FirePower, 0.15f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_R_005", displayName="물 마법사의 귀걸이",grade=AccessoryGrade.Rare, accessoryType="속성", description="물 속성 대미지 +15%, 투사체 크기 +5%",   effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.WaterPower, 0.15f), Multi(StatType.ProjectileSize, 0.05f) } });
        list.Add(new AccessoryDef { fileName="ACC_R_006", displayName="눈꽃 결정체",          grade=AccessoryGrade.Rare, accessoryType="특수", description="타격 시 동결 확률 +15%",               effectType=AccessoryEffectType.FreezeChance, modifiers=new List<StatModifier>{ Flat(StatType.FreezePower, 0.15f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_R_016", displayName="신비한 약병",        grade=AccessoryGrade.Rare, accessoryType="특수", description="포션 효과 +8%",                       effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.HealingBonus, 0.08f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_R_019", displayName="마법의 구",        grade=AccessoryGrade.Rare, accessoryType="특수", description="피격 시 8방향으로 복수 마법 발사 (쿨타임 5초)",    effectType=AccessoryEffectType.RevengeArrow, modifiers=new List<StatModifier>() });
        ...
        list.Add(new AccessoryDef { fileName="ACC_R_029", displayName="고무 화살촉", grade=AccessoryGrade.Rare, accessoryType="특수", description="투사체 속도 +40%, 모든 투사체에 벽 튕기기 1회 부여", effectType=AccessoryEffectType.Ricochet, modifiers=new List<StatModifier>{Multi(StatType.ProjectileSpeed, 0.4f)}});
        ...
        list.Add(new AccessoryDef { fileName="ACC_R_038", displayName="불투명한 프리즘",    grade=AccessoryGrade.Rare, accessoryType="특수", description="공격 시 랜덤 상태이상 (화상/독/출혈)",           effectType=AccessoryEffectType.RandomElement, modifiers=new List<StatModifier>() });
        ...
        // ── 유니크 ───────────────────────────────────────────
        list.Add(new AccessoryDef { fileName="ACC_U_001", displayName="대마법사의 부서진 지팡이", grade=AccessoryGrade.Unique, accessoryType="특수", description="크리티컬 확률 +30%",          effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.CritChance, 0.3f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_U_003", displayName="차원의 나침반",           grade=AccessoryGrade.Unique, accessoryType="특수", description="회피율 +20%",           effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.Evasion, 0.2f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_U_006", displayName="연금술사의 가방",         grade=AccessoryGrade.Unique, accessoryType="유틸", description="골드 획득량 +50%",        effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.GoldGainBonus, 0.5f) } });
        list.Add(new AccessoryDef { fileName="ACC_U_007", displayName="태풍의 눈",              grade=AccessoryGrade.Unique, accessoryType="공격", description="관통 및 투사체 크기 +20%, 사거리 +15%",            effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.ProjectileSize, 0.2f), Multi(StatType.ProjectileRange, 0.15f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_U_011", displayName="검은 구멍",              grade=AccessoryGrade.Unique, accessoryType="특수", description="10% 확률로 필드 내 모든 적 속박, 투사체 크기 +30%", effectType=AccessoryEffectType.BlackHolePull, modifiers=new List<StatModifier>{ Multi(StatType.ProjectileSize, 0.3f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_U_014", displayName="폭발성 물약",            grade=AccessoryGrade.Unique, accessoryType="특수", description="공격 시 20% 확률로 광역 폭발",                    effectType=AccessoryEffectType.Explosion, modifiers=new List<StatModifier>() });
        ...
        list.Add(new AccessoryDef { fileName="ACC_U_016", displayName="메아리의 소라",          grade=AccessoryGrade.Unique, accessoryType="특수", description="이속 +30%, 피해감소 +10%",   effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.MovementSpeed, 0.3f), Multi(StatType.DamageReduction, 0.1f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_U_021", displayName="고대 문양",              grade=AccessoryGrade.Unique, accessoryType="특수", description="공격속도 +50%",               effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.AttackSpeed, 0.5f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_L_007", displayName="신의 방패",              grade=AccessoryGrade.Legendary, accessoryType="방어", description="[절대 영역] 15초간 받는 피해 0.01 고정, 모든 상태이상 면역",         effectType=AccessoryEffectType.GodShield, modifiers=new List<StatModifier>() });
        ...
        list.Add(new AccessoryDef { fileName="ACC_L_012", displayName="The Last Rune",         grade=AccessoryGrade.Legendary, accessoryType="특수", description="모든 스탯 100% 증가",      effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.AttackPower, 1f), Multi(StatType.AttackSpeed, 1f), Multi(StatType.ProjectileSpeed, 1f), Multi(StatType.ProjectileRange, 1f), Multi(StatType.ProjectileSize, 1f), Multi(StatType.MeleeRange, 1f), Multi(StatType.CritChance, 1f), Multi(StatType.CritDamage, 1f), Multi(StatType.MovementSpeed, 1f), Multi(StatType.MaxHP, 1f), Multi(StatType.Defense, 1f), Multi(StatType.DamageReduction, 1f), Multi(StatType.Evasion, 1f), Multi(StatType.HealingBonus, 1f), Multi(StatType.GoldGainBonus, 1f) } });
