...
public static class AccessoryCreator
{
    ...
    static List<AccessoryDef> GetAllAccessoryDefs()
    {
        ...
        list.Add(new AccessoryDef { fileName="ACC_R_029", displayName="고무 화살촉",        grade=AccessoryGrade.Rare, accessoryType="특수", description="투사체 속도 +40%",   effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.ProjectileSpeed, 0.4f) } });
