...
public static class AccessoryCreator
{
    ...
    static List<AccessoryDef> GetAllAccessoryDefs()
    {
        ...
        list.Add(new AccessoryDef { fileName="ACC_C_041", displayName="헌 나침반",        grade=AccessoryGrade.Common, accessoryType="공격", description="투사체 사거리 +10 (고정)",            effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Flat(StatType.ProjectileRange, 10f) } });
        ...
        list.Add(new AccessoryDef { fileName="ACC_U_007", displayName="태풍의 눈",              grade=AccessoryGrade.Unique, accessoryType="공격", description="관통 및 투사체 크기 +20%, 사거리 +15%",            effectType=AccessoryEffectType.None, modifiers=new List<StatModifier>{ Multi(StatType.ProjectileRange, 0.15f), Multi(StatType.ProjectileSize, 0.2f) } });
